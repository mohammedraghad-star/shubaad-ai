  ...
  return (
    <main style={{ padding: 32, fontFamily: 'Arial, sans-serif', maxWidth: 1100, margin: '0 auto' }}>
      <section style={{ marginBottom: 32 }}>
        ...
        <h1 style={{ fontSize: 52, margin: '8px 0' }}>SHUBAAD</h1>
      ...
      <section style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 32 }}>
        {[
          ['Spectral Engine', 'FTIR preprocessing, peak detection, PCA-ready outputs'],
      ...
      <section style={{ border: '1px solid #ddd', borderRadius: 16, padding: 24 }}>
        ...
        <br /><br />
        <button onClick={runAnalysis} style={{ padding: '12px 18px', borderRadius: 10, cursor: 'pointer' }}>
